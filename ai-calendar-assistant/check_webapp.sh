...
MENU_URL=$(curl -s "https://api.telegram.org/bot8378762774:AAE7oEvJX3fcHmLTQJPzQb9EIgQHXUWuaPI/getChatMenuButton" | python3 -c "import sys, json; d=json.load(sys.stdin); print(d['result']['web_app']['url'])" 2>/dev/null)
echo "   URL: $MENU_URL"
