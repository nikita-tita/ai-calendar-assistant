...
class TelegramHandler:
    ...
    async def handle_update(self, update: Update) -> None:
        ...
        try:
            ...
            # Handle property button (kept for compatibility)
...
Выбрать новостройку из тысячи вариантов
...
Просто выбери свой сервис, а дальше подключатся наши специалисты"""
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("🏢 Подбор новостроек", callback_data="services:property_search")]
        ])
...
Можете писать текстом или голосом."""
        ...
        # Handle services menu callbacks
        elif data == "services:property_search":
            # Show property search bot message
            message = """🏢 <b>Поиск недвижимости</b>
