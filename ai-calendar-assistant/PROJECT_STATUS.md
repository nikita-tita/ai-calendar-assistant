...
### Высокий (High) — ВСЕ ЗАКРЫТЫ ✅ (13 из 13)
...
10. ~~**UX-001:** Light theme~~ — DONE (2026-01-11, --border-color)
...
2. ~~**Неделя 2:** Закрыть High-проблемы~~ — ✅ DONE (все 13 закрыты!)
   - ~~INFRA-002: Prometheus + Grafana~~ — ✅ DONE
   - ~~ARCH-001: Рефакторинг extract_event()~~ — ✅ DONE
   - ~~ARCH-002: Рефакторинг handle_callback_query()~~ — ✅ DONE
   - ~~UX-001: Light theme fix~~ — ✅ DONE
3. **Текущий приоритет:** Backlog (17 Medium + 3 Low)
