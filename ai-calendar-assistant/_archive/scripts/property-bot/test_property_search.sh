...
echo "🚀 Starting property search tests..."
echo "📊 Total test cases: ${#queries[@]}"
...
for i in "${!queries[@]}"; do
    ...
    if [ $test_num -lt ${#queries[@]} ]; then
        wait_time=12
        echo "⏳ Waiting ${wait_time}s before next test..."
        sleep $wait_time
    fi
    echo ""
done
...
echo "================================================================================"
echo "📊 Test Summary:"
echo "✅ Successful: $success/${#queries[@]}"
echo "❌ Failed: $failed/${#queries[@]}"
echo "================================================================================"
echo ""
echo "💡 Check bot logs on server:"
